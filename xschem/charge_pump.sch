...
C {devices/lab_pin.sym} 750 -300 0 0 {name=p13 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} 750 -110 0 0 {name=p1 sig_type=std_logic lab=GND}
...
C {devices/ipin.sym} 530 -210 0 0 {name=p9 lab=VDD}
C {devices/ipin.sym} 530 -190 0 0 {name=p10 lab=GND}
C {sky130_stdcells/inv_1.sym} 630 -260 0 0 {name=x1 VGND=GND VNB=GND VPB=VDD VPWR=VDD prefix=sky130_fd_sc_hd__ }
C {devices/param.sym} 420 -130 0 0 {name=s1 value="
+wpmos=10
+wnmos=10
+lmos=1.2"}
C {sky130_stdcells/buf_1.sym} 660 -150 0 0 {name=x2 VGND=GND VNB=GND VPB=VDD VPWR=VDD prefix=sky130_fd_sc_hd__ }
