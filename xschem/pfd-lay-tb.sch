...
descr="load tran" 
tclcommand="xschem raw_read $netlist_dir/pfd-lay-tb.raw tran"
}
...
"}
C {devices/simulator_commands.sym} 200 -300 0 0 {name=COMMANDS
simulator=ngspice
only_toplevel=false 
value="  
  .include ~/sky130_projects/sky130_its_biomedical_chip_research_2024/spice/pfd-pex-lay.spice
...
C {pfd-lay.sym} 720 -250 0 0 {name=x1}
