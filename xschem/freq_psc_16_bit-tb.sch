...
only_toplevel=false 
value="
  .include ~/sky130_projects/sky130_its_biomedical_chip_research_2024/spice/freq_psc_16_bit.spice
  ...
  .control
     ...
     +psc[6] psc[7] psc[8] psc[9] psc[10] psc[11] psc[12] psc[13] 
     +psc[14] psc[15] rst
     tran 0.01n 500n uic
     remzerovec
     write freq_psc_16_bit-tb.raw
    quit 0
  .endc
"}
...
C {devices/lab_pin.sym} 300 -150 0 0 {name=p4 sig_type=std_logic lab=psc[0:15]}
...
"}
C {freq_psc_16_bit.sym} 450 -170 0 0 {name=x1}
